...
const REGION_CONFIG = {
  ...
  megantoni: {
    ...
    variables: [
      ...
      { group: 'Preferencias Diputados', key: 'pct_marq',  label: '% Anali Márquez (JxP)',        unit: '%', min: 0, max: 8, palette: ['#dcfce7','#86efac','#4ade80','#16a34a','#15803d','#14532d'] },
      { group: 'Preferencias Diputados', key: 'pct_julian',label: '% Julian Perez (JxP)',          unit: '%', min: 0, max: 6, palette: ['#dcfce7','#86efac','#4ade80','#16a34a','#15803d','#14532d'] },
      { group: 'Preferencias Diputados', key: 'pct_holg',  label: '% Cesar Holguín (Ahora N.)',    unit: '%', min: 0, max: 8, palette: ['#fef9c3','#fde047','#facc15','#ca8a04','#a16207','#713f12'] },
      { group: 'Preferencias Diputados', key: 'pct_lopez', label: '% Heber Lopez (Obras)',         unit: '%', min: 0, max: 3, palette: ['#dbeafe','#93c5fd','#60a5fa','#2563eb','#1d4ed8','#1e3a8a'] },
      { group: 'Preferencias Diputados', key: 'pct_edwin', label: '% Edwin Espinoza (Buen Gob.)',  unit: '%', min: 0, max: 2, palette: ['#fdf4ff','#f0abfc','#d946ef','#a21caf','#701a75','#4a044e'] },
    ...
    panelCandidatos: [
      ...
      // Preferencias diputados
      [
        { label: 'Anali Márquez (JxP)',       pct: 'pct_marq',  pref: 'pref_marq',  color: '#4ade80' },
        { label: 'Julian Perez (JxP)',         pct: 'pct_julian',pref: 'pref_juli', color: '#86efac' },
        { label: 'Cesar Holguín (Ahora N.)',  pct: 'pct_holg',  pref: 'pref_holg',  color: '#facc15' },
        { label: 'Heber Lopez (Obras)',        pct: 'pct_lopez', pref: 'pref_lopez', color: '#60a5fa' },
        { label: 'Edwin Espinoza (Buen Gob.)',pct: 'pct_edwin', pref: 'pref_edwin', color: '#d946ef' },
      ],
    ],
  },
}
